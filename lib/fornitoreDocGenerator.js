...
export async function generateFornitorePdf({ user, fornitore,condominio_id, formData }) {    
...
<div style="margin-top: 4cm; text-align: center; font-family: 'Times New Roman', serif;">
  <p style="margin: 0;">
  ...
  <p>Il Condominio ${intestazione.condominio}, ${intestazione.cap} ${intestazione.citta}(${intestazione.provincia}) C.F. ${intestazione.codiceFiscale}} previa verifica della
...
">
  ...
  <p style="margin: 2px 0; padding: 0;">${fornitore.indirizzo || ""}</p>
  <p style="margin: 2px 0; padding: 0;">${fornitore.cap || ""} ${fornitore.citta || ""} ${fornitore.provincia || ""}</p>
